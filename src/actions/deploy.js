...
import { abi } from '@marketprotocol/marketprotocol/build/contracts/MarketContractOraclize';
...
export function deployContract(
  ...
  return async function(dispatch) {
    ...
    const deployedMarketContract = contract.at(marketContractAddress);
    dispatch({
      type: `${type}_FULFILLED`,
      payload: deployedMarketContract
    });
  };
}
